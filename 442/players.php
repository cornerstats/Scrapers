...
// oh but wait there is loads of junk here we can strip out too
				...
				// create the urls
				// http://www.fourfourtwo.com/statszone/8-2014/matches/755556/player-stats/66749/0_SHOT_01#tabs-wrapper-anchor
				$url_1 = "http://www.fourfourtwo.com/statszone/8-2014/matches/{$match}/player-stats/{$team1}/";
				...
				if (isset($match) && $match !== '') {
					...
					<form action="<?php $_SERVER['PHP_SELF'];?>" method="POST">
						...
						<div class="form-group">
							<label for="plyr">Player Team ID:</label>
